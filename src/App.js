...
import { login, logout, register, getUserInfo } from './utils/main'; 
...
    });
    ...
    // MANTENEMOS EL ESTADO INICIAL EN NULL
...
    // Cargar productos y revisar sesión al inicio (CORRECCIÓN SÍNCRONA)
    useEffect(() => {
        // La función es SÍNCRONA, se llama directamente.
        const loadedProducts = DataService.getProducts();
        
        // CORRECCIÓN: Usamos un pequeño retraso para simular la carga
        // Esto evita que React intente renderizar todo inmediatamente y mejora la experiencia
        setTimeout(() => {
...
        // Al ser síncrona, llamamos directamente.
